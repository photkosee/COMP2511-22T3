...
public class Task1ExampleTests {
    ...
    public void testExample() {
        ...
        // add more satellites
        controller.createSatellite("Satellite2", "TeleportingSatellite", 1333 + RADIUS_OF_JUPITER,
            Angle.fromDegrees(0));
        controller.createSatellite("Satellite3", "RelaySatellite", 10 + RADIUS_OF_JUPITER, Angle.fromDegrees(77));

        assertEquals(new EntityInfoResponse("Satellite2", Angle.fromDegrees(0), 1333 + RADIUS_OF_JUPITER,
            "TeleportingSatellite"), controller.getInfo("Satellite2"));
        assertEquals(new EntityInfoResponse("Satellite3", Angle.fromDegrees(77), 10 + RADIUS_OF_JUPITER,
