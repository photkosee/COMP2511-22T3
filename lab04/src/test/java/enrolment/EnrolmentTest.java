...
public class EnrolmentTest {
    ...
    public void testComparator() {
        ...
        List<Student> sortedStudents = parseStudentsCSV("/sortedStudents.csv");
        students.sort(new Cmp());
        // Replace this with your failing unit test
        ListIterator<Student> iterator = students.listIterator();
        ListIterator<Student> sortedIterator = sortedStudents.listIterator();
        while (iterator.hasNext()) {
            assertTrue(iterator.next().getId().equals(sortedIterator.next().getId()));
        }
    }
}
